...
// src/index.ts
//
// Single entry point for SCD MCP Docs.
//
// Usage:
//   scd-mcp-docs          Start the MCP server (default)
//   scd-mcp-docs auth     Run the interactive OAuth flow
//
...
try {
  if (isRemote) {
    ...
    logger.info('Starting SCD MCP Docs server...');
